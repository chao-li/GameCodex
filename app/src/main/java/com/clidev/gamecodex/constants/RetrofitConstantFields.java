...
public class RetrofitConstantFields {
    ...
    public static final String FIELDS = "id,name,genres,url,summary,aggregated_rating,platforms,popularity,cover,developers,publishers,player_perspectives,game_modes,first_release_date,release_dates,artworks,videos,multiplayer_modes";
